        ...
        <div class="row">
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="SqlDataSource1" CellPadding="4" ForeColor="#333333" GridLines="None">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="选择主题" HeaderText="Title" SortExpression="title" />
                    <asp:BoundField DataField="起始时间" HeaderText="Start" SortExpression="starttime" />
                    <asp:BoundField DataField="结束时间" HeaderText="End" SortExpression="endtime" />
                    <asp:BoundField DataField="备注" HeaderText="Description" SortExpression="descriptionelection" />
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:votingdatabase %>" ProviderName="System.Data.SqlClient" SelectCommand="SELECT * FROM [elections]"></asp:SqlDataSource>
        </div>
    </div>
       </form>
